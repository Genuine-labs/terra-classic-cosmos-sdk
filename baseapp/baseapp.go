...
func (app *BaseApp) runTx(mode execMode, txBytes []byte) (gInfo sdk.GasInfo, result *sdk.Result, anteEvents []abci.Event, tx sdk.Tx, err error) {
	...
	if app.postHandler != nil {
		...
		if errPostHandler != nil {
			return gInfo, nil, anteEvents, nil, errors.Join(err, errPostHandler)
		}
